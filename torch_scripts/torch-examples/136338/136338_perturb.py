...
print(f"Single[0] == Double[0]? {is_strict_equal}")
print(f"max_diff: {max_diff.item():.10e}")

saved_data = {
    "outputs": {
        "result_batch_1_perturb": result_single 
    },
    "timings": {
        "b1_duration": duration_b1,
        "b2_duration": duration_b2
    },
    "analysis": {
