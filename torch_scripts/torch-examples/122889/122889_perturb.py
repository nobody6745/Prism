...
# --- Method 1: Full Sequence Calculation ---
t1_start = time.perf_counter()
x1 = l(x)
t1_end = time.perf_counter()
duration_x1 = t1_end - t1_start

# Extract the last token's slice for comparison
x1_slice = x1[:, -1:, :]

# --- Method 2: Sliced Input Calculation ---
...
saved_data = {
    "outputs": {
        "x1_slice_perturb": x1_slice
    },
    "timings": {
        "duration_x1_full": duration_x1,
        "duration_x2_slice": duration_x2
    }
}
