...
print(f" Initialization took: {time.perf_counter() - t_init_start:.4f} s")
...
saved_data = {
    "dot": {"thread_1_perturb": res_1["dot"]},
    "sum": {"thread_1_perturb": res_1["sum"]},
    "timings": {"res_1": res_1["timings"], "res_10": res_10["timings"]}
}
